...
export default function( editor ) {
	...
	function enter( event ) {
		...
		// WE call preventDefault and stopImmediatePropagation in order to prevent TinyMCE from creating additional newlines.
		// The calls also prevent TinyMCE's own processing of keydown which conflicts with the block replacement (since the instance is destroyed)
		event.preventDefault();
		event.stopImmediatePropagation();
	}
}
